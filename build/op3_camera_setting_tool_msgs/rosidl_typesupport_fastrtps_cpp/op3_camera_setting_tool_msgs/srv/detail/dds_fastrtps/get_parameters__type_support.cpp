...
#include "op3_camera_setting_tool_msgs/srv/detail/get_parameters__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const op3_camera_setting_tool_msgs::srv::GetParameters_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  op3_camera_setting_tool_msgs::srv::GetParameters_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = op3_camera_setting_tool_msgs::srv::GetParameters_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const op3_camera_setting_tool_msgs::srv::GetParameters_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<op3_camera_setting_tool_msgs::srv::GetParameters_Request *>(
    untyped_ros_message);
...
{
  return &op3_camera_setting_tool_msgs::srv::typesupport_fastrtps_cpp::_GetParameters_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_camera_setting_tool_msgs, srv, GetParameters_Request)() {
  return &op3_camera_setting_tool_msgs::srv::typesupport_fastrtps_cpp::_GetParameters_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_op3_camera_setting_tool_msgs
cdr_serialize(
  const op3_camera_setting_tool_msgs::srv::GetParameters_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: returns
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  op3_camera_setting_tool_msgs::srv::GetParameters_Response & ros_message)
{
  // Member: returns
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = op3_camera_setting_tool_msgs::srv::GetParameters_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const op3_camera_setting_tool_msgs::srv::GetParameters_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<op3_camera_setting_tool_msgs::srv::GetParameters_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &op3_camera_setting_tool_msgs::srv::typesupport_fastrtps_cpp::_GetParameters_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_camera_setting_tool_msgs, srv, GetParameters_Response)() {
  return &op3_camera_setting_tool_msgs::srv::typesupport_fastrtps_cpp::_GetParameters_Response__handle;
}
...
{
  return &op3_camera_setting_tool_msgs::srv::typesupport_fastrtps_cpp::_GetParameters__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_camera_setting_tool_msgs, srv, GetParameters)() {
  return &op3_camera_setting_tool_msgs::srv::typesupport_fastrtps_cpp::_GetParameters__handle;
}
