...
static const _V4lParameter_type_support_symbol_names_t _V4lParameter_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_camera_setting_tool_msgs, msg, V4lParameter)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_camera_setting_tool_msgs, msg, V4lParameter)),
  }
};
...
{
  return &::op3_camera_setting_tool_msgs::msg::rosidl_typesupport_cpp::V4lParameter_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, op3_camera_setting_tool_msgs, msg, V4lParameter)() {
  return get_message_type_support_handle<op3_camera_setting_tool_msgs::msg::V4lParameter>();
}
