...
static const _V4lParameters_type_support_symbol_names_t _V4lParameters_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_camera_setting_tool_msgs, msg, V4lParameters)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_camera_setting_tool_msgs, msg, V4lParameters)),
  }
};
...
{
  return &::op3_camera_setting_tool_msgs::msg::rosidl_typesupport_cpp::V4lParameters_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, op3_camera_setting_tool_msgs, msg, V4lParameters)() {
  return get_message_type_support_handle<op3_camera_setting_tool_msgs::msg::V4lParameters>();
}
