...
static const _SetParameters_Request_type_support_symbol_names_t _SetParameters_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_camera_setting_tool_msgs, srv, SetParameters_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_camera_setting_tool_msgs, srv, SetParameters_Request)),
  }
};
...
{
  return &::op3_camera_setting_tool_msgs::srv::rosidl_typesupport_cpp::SetParameters_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, op3_camera_setting_tool_msgs, srv, SetParameters_Request)() {
  return get_message_type_support_handle<op3_camera_setting_tool_msgs::srv::SetParameters_Request>();
}
...
static const _SetParameters_Response_type_support_symbol_names_t _SetParameters_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_camera_setting_tool_msgs, srv, SetParameters_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_camera_setting_tool_msgs, srv, SetParameters_Response)),
  }
};
...
{
  return &::op3_camera_setting_tool_msgs::srv::rosidl_typesupport_cpp::SetParameters_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, op3_camera_setting_tool_msgs, srv, SetParameters_Response)() {
  return get_message_type_support_handle<op3_camera_setting_tool_msgs::srv::SetParameters_Response>();
}
...
static const _SetParameters_type_support_symbol_names_t _SetParameters_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_camera_setting_tool_msgs, srv, SetParameters)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_camera_setting_tool_msgs, srv, SetParameters)),
  }
};
...
{
  return &::op3_camera_setting_tool_msgs::srv::rosidl_typesupport_cpp::SetParameters_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, op3_camera_setting_tool_msgs, srv, SetParameters)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<op3_camera_setting_tool_msgs::srv::SetParameters>();
}
