...
bool op3_camera_setting_tool_msgs__msg__v4l_parameter__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("op3_camera_setting_tool_msgs.msg._v4l_parameter.V4lParameter", full_classname_dest, 60) == 0);
  }
  op3_camera_setting_tool_msgs__msg__V4lParameter * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of V4lParameter */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("op3_camera_setting_tool_msgs.msg._v4l_parameter");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "V4lParameter");
