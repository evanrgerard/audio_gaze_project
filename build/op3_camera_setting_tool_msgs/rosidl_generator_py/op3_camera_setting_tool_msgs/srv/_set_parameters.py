...
class Metaclass_SetParameters_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from op3_camera_setting_tool_msgs.msg import CameraParams
            if CameraParams.__class__._TYPE_SUPPORT is None:
                CameraParams.__class__.__import_type_support__()
...
class SetParameters_Request(metaclass=Metaclass_SetParameters_Request):
    ...
    _fields_and_field_types = {
        'params': 'op3_camera_setting_tool_msgs/CameraParams',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['op3_camera_setting_tool_msgs', 'msg'], 'CameraParams'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from op3_camera_setting_tool_msgs.msg import CameraParams
        self.params = kwargs.get('params', CameraParams())
    ...
    def params(self, value):
        if __debug__:
            from op3_camera_setting_tool_msgs.msg import CameraParams
            assert \
                isinstance(value, CameraParams), \
                "The 'params' field must be a sub message of type 'CameraParams'"
        self._params = value
...
class SetParameters_Response(metaclass=Metaclass_SetParameters_Response):
    ...
    _fields_and_field_types = {
        'returns': 'op3_camera_setting_tool_msgs/CameraParams',
    }
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            ...
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        from op3_camera_setting_tool_msgs.msg import CameraParams
        self.returns = kwargs.get('returns', CameraParams())
    ...
    def returns(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, CameraParams), \
                "The 'returns' field must be a sub message of type 'CameraParams'"
        self._returns = value
...
class Metaclass_SetParameters(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'op3_camera_setting_tool_msgs.srv.SetParameters')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from op3_camera_setting_tool_msgs.srv import _set_parameters
...
class SetParameters(metaclass=Metaclass_SetParameters):
    from op3_camera_setting_tool_msgs.srv._set_parameters import SetParameters_Request as Request
    from op3_camera_setting_tool_msgs.srv._set_parameters import SetParameters_Response as Response
