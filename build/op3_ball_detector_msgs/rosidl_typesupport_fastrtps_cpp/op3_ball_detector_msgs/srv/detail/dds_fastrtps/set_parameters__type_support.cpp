...
#include "op3_ball_detector_msgs/srv/detail/set_parameters__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const op3_ball_detector_msgs::srv::SetParameters_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  op3_ball_detector_msgs::srv::SetParameters_Request & ros_message)
{
  // Member: params
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = op3_ball_detector_msgs::srv::SetParameters_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const op3_ball_detector_msgs::srv::SetParameters_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<op3_ball_detector_msgs::srv::SetParameters_Request *>(
    untyped_ros_message);
...
{
  return &op3_ball_detector_msgs::srv::typesupport_fastrtps_cpp::_SetParameters_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_ball_detector_msgs, srv, SetParameters_Request)() {
  return &op3_ball_detector_msgs::srv::typesupport_fastrtps_cpp::_SetParameters_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for op3_ball_detector_msgs::msg::BallDetectorParams already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_op3_ball_detector_msgs
cdr_serialize(
  const op3_ball_detector_msgs::srv::SetParameters_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: returns
  op3_ball_detector_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  op3_ball_detector_msgs::srv::SetParameters_Response & ros_message)
{
  // Member: returns
  op3_ball_detector_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = op3_ball_detector_msgs::srv::SetParameters_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const op3_ball_detector_msgs::srv::SetParameters_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<op3_ball_detector_msgs::srv::SetParameters_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &op3_ball_detector_msgs::srv::typesupport_fastrtps_cpp::_SetParameters_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_ball_detector_msgs, srv, SetParameters_Response)() {
  return &op3_ball_detector_msgs::srv::typesupport_fastrtps_cpp::_SetParameters_Response__handle;
}
...
{
  return &op3_ball_detector_msgs::srv::typesupport_fastrtps_cpp::_SetParameters__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_ball_detector_msgs, srv, SetParameters)() {
  return &op3_ball_detector_msgs::srv::typesupport_fastrtps_cpp::_SetParameters__handle;
}
