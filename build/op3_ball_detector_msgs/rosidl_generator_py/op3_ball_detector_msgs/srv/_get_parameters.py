...
class Metaclass_GetParameters(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'op3_ball_detector_msgs.srv.GetParameters')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from op3_ball_detector_msgs.srv import _get_parameters
...
class GetParameters(metaclass=Metaclass_GetParameters):
    from op3_ball_detector_msgs.srv._get_parameters import GetParameters_Request as Request
    from op3_ball_detector_msgs.srv._get_parameters import GetParameters_Response as Response
