...
{
  new (message_memory) op3_ball_detector_msgs::srv::SetParameters_Request(_init);
}

void SetParameters_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<op3_ball_detector_msgs::srv::SetParameters_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetParameters_Request_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<op3_ball_detector_msgs::msg::BallDetectorParams>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(op3_ball_detector_msgs::srv::SetParameters_Request, params),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetParameters_Request_message_members = {
  "op3_ball_detector_msgs::srv",  // message namespace
  "SetParameters_Request",  // message name
  1,  // number of fields
  sizeof(op3_ball_detector_msgs::srv::SetParameters_Request),
...
{
  return &::op3_ball_detector_msgs::srv::rosidl_typesupport_introspection_cpp::SetParameters_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_ball_detector_msgs, srv, SetParameters_Request)() {
  return &::op3_ball_detector_msgs::srv::rosidl_typesupport_introspection_cpp::SetParameters_Request_message_type_support_handle;
}
...
void SetParameters_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) op3_ball_detector_msgs::srv::SetParameters_Response(_init);
}

void SetParameters_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<op3_ball_detector_msgs::srv::SetParameters_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetParameters_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(op3_ball_detector_msgs::srv::SetParameters_Response, returns),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetParameters_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(op3_ball_detector_msgs::srv::SetParameters_Response),
...
{
  return &::op3_ball_detector_msgs::srv::rosidl_typesupport_introspection_cpp::SetParameters_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_ball_detector_msgs, srv, SetParameters_Response)() {
  return &::op3_ball_detector_msgs::srv::rosidl_typesupport_introspection_cpp::SetParameters_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetParameters_service_members = {
  "op3_ball_detector_msgs::srv",  // service namespace
  "SetParameters",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<op3_ball_detector_msgs::srv::SetParameters>()
...
get_service_type_support_handle<op3_ball_detector_msgs::srv::SetParameters>()
{
  ...
  auto service_type_support =
    &::op3_ball_detector_msgs::srv::rosidl_typesupport_introspection_cpp::SetParameters_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_ball_detector_msgs, srv, SetParameters)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<op3_ball_detector_msgs::srv::SetParameters>();
}
