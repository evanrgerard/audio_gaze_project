...
#include "op3_ball_detector_msgs/srv/detail/set_parameters__rosidl_typesupport_fastrtps_c.h"
...
#include "op3_ball_detector_msgs/msg/detail/ball_detector_params__functions.h"  // params
...
using _SetParameters_Request__ros_msg_type = op3_ball_detector_msgs__srv__SetParameters_Request;
...
size_t get_serialized_size_op3_ball_detector_msgs__srv__SetParameters_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetParameters_Request__ros_msg_type * ros_message = static_cast<const _SetParameters_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetParameters_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_op3_ball_detector_msgs__srv__SetParameters_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_ball_detector_msgs
size_t max_serialized_size_op3_ball_detector_msgs__srv__SetParameters_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = op3_ball_detector_msgs__srv__SetParameters_Request;
    is_plain =
      (
...
static size_t _SetParameters_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_op3_ball_detector_msgs__srv__SetParameters_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_ball_detector_msgs, srv, SetParameters_Request)() {
...
using _SetParameters_Response__ros_msg_type = op3_ball_detector_msgs__srv__SetParameters_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_ball_detector_msgs
size_t get_serialized_size_op3_ball_detector_msgs__srv__SetParameters_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetParameters_Response__ros_msg_type * ros_message = static_cast<const _SetParameters_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_op3_ball_detector_msgs__srv__SetParameters_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_ball_detector_msgs
size_t max_serialized_size_op3_ball_detector_msgs__srv__SetParameters_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = op3_ball_detector_msgs__srv__SetParameters_Response;
    is_plain =
      (
...
static size_t _SetParameters_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_op3_ball_detector_msgs__srv__SetParameters_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_ball_detector_msgs, srv, SetParameters_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_ball_detector_msgs, srv, SetParameters)() {
