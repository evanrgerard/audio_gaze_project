...
#include "op3_ball_detector_msgs/srv/detail/get_parameters__rosidl_typesupport_fastrtps_c.h"
...
using _GetParameters_Request__ros_msg_type = op3_ball_detector_msgs__srv__GetParameters_Request;
...
size_t get_serialized_size_op3_ball_detector_msgs__srv__GetParameters_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetParameters_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_op3_ball_detector_msgs__srv__GetParameters_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_ball_detector_msgs
size_t max_serialized_size_op3_ball_detector_msgs__srv__GetParameters_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = op3_ball_detector_msgs__srv__GetParameters_Request;
    is_plain =
      (
...
static size_t _GetParameters_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_op3_ball_detector_msgs__srv__GetParameters_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_ball_detector_msgs, srv, GetParameters_Request)() {
...
#include "op3_ball_detector_msgs/msg/detail/ball_detector_params__functions.h"  // returns
...
using _GetParameters_Response__ros_msg_type = op3_ball_detector_msgs__srv__GetParameters_Response;
  ...
  // Field name: returns
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, op3_ball_detector_msgs, msg, BallDetectorParams
      )()->data);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_ball_detector_msgs
size_t get_serialized_size_op3_ball_detector_msgs__srv__GetParameters_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetParameters_Response__ros_msg_type * ros_message = static_cast<const _GetParameters_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_op3_ball_detector_msgs__msg__BallDetectorParams(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_op3_ball_detector_msgs__srv__GetParameters_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_ball_detector_msgs
size_t max_serialized_size_op3_ball_detector_msgs__srv__GetParameters_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: returns
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_op3_ball_detector_msgs__msg__BallDetectorParams(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = op3_ball_detector_msgs__srv__GetParameters_Response;
    is_plain =
      (
...
static size_t _GetParameters_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_op3_ball_detector_msgs__srv__GetParameters_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_ball_detector_msgs, srv, GetParameters_Response)() {
...
// already included above
// #include "op3_ball_detector_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "op3_ball_detector_msgs/srv/get_parameters.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_ball_detector_msgs, srv, GetParameters)() {
