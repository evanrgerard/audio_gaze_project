...
{
  new (message_memory) op3_online_walking_module_msgs::msg::JointPose(_init);
}

void JointPose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<op3_online_walking_module_msgs::msg::JointPose *>(message_memory);
  typed_message->~JointPose();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember JointPose_message_member_array[2] = {
  {
    "mov_time",  // name
    ...
    offsetof(op3_online_walking_module_msgs::msg::JointPose, mov_time),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(op3_online_walking_module_msgs::msg::JointPose, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JointPose_message_members = {
  ...
  2,  // number of fields
  sizeof(op3_online_walking_module_msgs::msg::JointPose),
...
get_message_type_support_handle<op3_online_walking_module_msgs::msg::JointPose>()
{
  return &::op3_online_walking_module_msgs::msg::rosidl_typesupport_introspection_cpp::JointPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_online_walking_module_msgs, msg, JointPose)() {
  return &::op3_online_walking_module_msgs::msg::rosidl_typesupport_introspection_cpp::JointPose_message_type_support_handle;
}
