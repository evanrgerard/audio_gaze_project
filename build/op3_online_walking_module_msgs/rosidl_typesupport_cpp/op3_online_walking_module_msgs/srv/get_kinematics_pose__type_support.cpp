...
static const _GetKinematicsPose_Request_type_support_symbol_names_t _GetKinematicsPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_online_walking_module_msgs, srv, GetKinematicsPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_online_walking_module_msgs, srv, GetKinematicsPose_Request)),
  }
};
...
{
  return &::op3_online_walking_module_msgs::srv::rosidl_typesupport_cpp::GetKinematicsPose_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, op3_online_walking_module_msgs, srv, GetKinematicsPose_Request)() {
  return get_message_type_support_handle<op3_online_walking_module_msgs::srv::GetKinematicsPose_Request>();
}
...
static const _GetKinematicsPose_Response_type_support_symbol_names_t _GetKinematicsPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_online_walking_module_msgs, srv, GetKinematicsPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_online_walking_module_msgs, srv, GetKinematicsPose_Response)),
  }
};
...
{
  return &::op3_online_walking_module_msgs::srv::rosidl_typesupport_cpp::GetKinematicsPose_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, op3_online_walking_module_msgs, srv, GetKinematicsPose_Response)() {
  return get_message_type_support_handle<op3_online_walking_module_msgs::srv::GetKinematicsPose_Response>();
}
...
static const _GetKinematicsPose_type_support_symbol_names_t _GetKinematicsPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_online_walking_module_msgs, srv, GetKinematicsPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_online_walking_module_msgs, srv, GetKinematicsPose)),
  }
};
...
{
  return &::op3_online_walking_module_msgs::srv::rosidl_typesupport_cpp::GetKinematicsPose_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, op3_online_walking_module_msgs, srv, GetKinematicsPose)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<op3_online_walking_module_msgs::srv::GetKinematicsPose>();
}
