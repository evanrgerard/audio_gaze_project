...
static const _JointPose_type_support_symbol_names_t _JointPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_online_walking_module_msgs, msg, JointPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_online_walking_module_msgs, msg, JointPose)),
  }
};
...
{
  return &::op3_online_walking_module_msgs::msg::rosidl_typesupport_cpp::JointPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, op3_online_walking_module_msgs, msg, JointPose)() {
  return get_message_type_support_handle<op3_online_walking_module_msgs::msg::JointPose>();
}
