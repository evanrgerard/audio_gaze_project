...
#include "op3_online_walking_module_msgs/srv/detail/get_kinematics_pose__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = op3_online_walking_module_msgs::srv::GetKinematicsPose_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const op3_online_walking_module_msgs::srv::GetKinematicsPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<op3_online_walking_module_msgs::srv::GetKinematicsPose_Request *>(
    untyped_ros_message);
...
{
  return &op3_online_walking_module_msgs::srv::typesupport_fastrtps_cpp::_GetKinematicsPose_Request__handle;
}
...
{
bool cdr_serialize(
  const op3_online_walking_module_msgs::msg::KinematicsPose &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  op3_online_walking_module_msgs::msg::KinematicsPose &);
  ...
  size_t current_alignment)
{
  ...
  // Member: pose
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        op3_online_walking_module_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_KinematicsPose(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = op3_online_walking_module_msgs::srv::GetKinematicsPose_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const op3_online_walking_module_msgs::srv::GetKinematicsPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<op3_online_walking_module_msgs::srv::GetKinematicsPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &op3_online_walking_module_msgs::srv::typesupport_fastrtps_cpp::_GetKinematicsPose_Response__handle;
}
...
{
  return &op3_online_walking_module_msgs::srv::typesupport_fastrtps_cpp::_GetKinematicsPose__handle;
}
