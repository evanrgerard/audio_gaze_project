...
#include "op3_online_walking_module_msgs/msg/detail/foot_step_array__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: moving_foot
  {
    ...
    size_t item_size = sizeof(ros_message.moving_foot[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = op3_online_walking_module_msgs::msg::FootStepArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const op3_online_walking_module_msgs::msg::FootStepArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<op3_online_walking_module_msgs::msg::FootStepArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FootStepArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const op3_online_walking_module_msgs::msg::FootStepArray *>(
...
static size_t _FootStepArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FootStepArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FootStepArray__callbacks = {
...
static rosidl_message_type_support_t _FootStepArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FootStepArray__callbacks,
...
{
  return &op3_online_walking_module_msgs::msg::typesupport_fastrtps_cpp::_FootStepArray__handle;
}
