...
#include "op3_online_walking_module_msgs/msg/detail/joint_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const op3_online_walking_module_msgs::msg::JointPose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  op3_online_walking_module_msgs::msg::JointPose & ros_message)
{
  // Member: mov_time
  cdr >> ros_message.mov_time;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = op3_online_walking_module_msgs::msg::JointPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const op3_online_walking_module_msgs::msg::JointPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<op3_online_walking_module_msgs::msg::JointPose *>(
    untyped_ros_message);
...
{
  return &op3_online_walking_module_msgs::msg::typesupport_fastrtps_cpp::_JointPose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_online_walking_module_msgs, msg, JointPose)() {
  return &op3_online_walking_module_msgs::msg::typesupport_fastrtps_cpp::_JointPose__handle;
}
