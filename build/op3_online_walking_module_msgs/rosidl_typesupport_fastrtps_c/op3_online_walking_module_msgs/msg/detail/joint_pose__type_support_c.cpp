...
#include "op3_online_walking_module_msgs/msg/detail/joint_pose__rosidl_typesupport_fastrtps_c.h"
...
#include "sensor_msgs/msg/detail/joint_state__functions.h"  // pose
...
using _JointPose__ros_msg_type = op3_online_walking_module_msgs__msg__JointPose;
...
static uint32_t _JointPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_op3_online_walking_module_msgs__msg__JointPose(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = op3_online_walking_module_msgs__msg__JointPose;
    is_plain =
      (
...
static size_t _JointPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_op3_online_walking_module_msgs__msg__JointPose(
