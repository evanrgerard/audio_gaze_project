...
#include "op3_online_walking_module_msgs/srv/detail/get_kinematics_pose__rosidl_typesupport_fastrtps_c.h"
...
using _GetKinematicsPose_Request__ros_msg_type = op3_online_walking_module_msgs__srv__GetKinematicsPose_Request;
...
size_t get_serialized_size_op3_online_walking_module_msgs__srv__GetKinematicsPose_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetKinematicsPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_op3_online_walking_module_msgs__srv__GetKinematicsPose_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_online_walking_module_msgs
size_t max_serialized_size_op3_online_walking_module_msgs__srv__GetKinematicsPose_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = op3_online_walking_module_msgs__srv__GetKinematicsPose_Request;
    is_plain =
      (
...
static size_t _GetKinematicsPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_op3_online_walking_module_msgs__srv__GetKinematicsPose_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_online_walking_module_msgs, srv, GetKinematicsPose_Request)() {
...
#include "op3_online_walking_module_msgs/msg/detail/kinematics_pose__functions.h"  // pose

// forward declare type support functions
size_t get_serialized_size_op3_online_walking_module_msgs__msg__KinematicsPose(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_op3_online_walking_module_msgs__msg__KinematicsPose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_online_walking_module_msgs, msg, KinematicsPose)();


using _GetKinematicsPose_Response__ros_msg_type = op3_online_walking_module_msgs__srv__GetKinematicsPose_Response;
  ...
  // Field name: pose
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, op3_online_walking_module_msgs, msg, KinematicsPose
      )()->data);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_online_walking_module_msgs
size_t get_serialized_size_op3_online_walking_module_msgs__srv__GetKinematicsPose_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetKinematicsPose_Response__ros_msg_type * ros_message = static_cast<const _GetKinematicsPose_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_op3_online_walking_module_msgs__msg__KinematicsPose(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_op3_online_walking_module_msgs__srv__GetKinematicsPose_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_online_walking_module_msgs
size_t max_serialized_size_op3_online_walking_module_msgs__srv__GetKinematicsPose_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: pose
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_op3_online_walking_module_msgs__msg__KinematicsPose(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = op3_online_walking_module_msgs__srv__GetKinematicsPose_Response;
    is_plain =
      (
...
static size_t _GetKinematicsPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_op3_online_walking_module_msgs__srv__GetKinematicsPose_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_online_walking_module_msgs, srv, GetKinematicsPose_Response)() {
...
// already included above
// #include "op3_online_walking_module_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "op3_online_walking_module_msgs/srv/get_kinematics_pose.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_online_walking_module_msgs, srv, GetKinematicsPose)() {
