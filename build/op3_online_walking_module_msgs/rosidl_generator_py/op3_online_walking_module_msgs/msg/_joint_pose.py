...
class JointPose(metaclass=Metaclass_JointPose):
    ...
    def __init__(self, **kwargs):
        ...
        self.mov_time = kwargs.get('mov_time', float())
        from sensor_msgs.msg import JointState
        self.pose = kwargs.get('pose', JointState())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.mov_time != other.mov_time:
            return False
    ...
    @builtins.property
    def mov_time(self):
        """Message field 'mov_time'."""
        return self._mov_time

    @mov_time.setter
    def mov_time(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'mov_time' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'mov_time' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._mov_time = value
    ...
    def pose(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'pose' field must be a sub message of type 'JointState'"
        self._pose = value
