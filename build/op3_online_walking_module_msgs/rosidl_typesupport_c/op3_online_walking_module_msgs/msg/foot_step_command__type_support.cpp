...
static const _FootStepCommand_type_support_symbol_names_t _FootStepCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_online_walking_module_msgs, msg, FootStepCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, op3_online_walking_module_msgs, msg, FootStepCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, op3_online_walking_module_msgs, msg, FootStepCommand)() {
  return &::op3_online_walking_module_msgs::msg::rosidl_typesupport_c::FootStepCommand_message_type_support_handle;
}
