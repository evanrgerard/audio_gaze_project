...
static const _PreviewRequest_type_support_symbol_names_t _PreviewRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_online_walking_module_msgs, msg, PreviewRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, op3_online_walking_module_msgs, msg, PreviewRequest)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, op3_online_walking_module_msgs, msg, PreviewRequest)() {
  return &::op3_online_walking_module_msgs::msg::rosidl_typesupport_c::PreviewRequest_message_type_support_handle;
}
