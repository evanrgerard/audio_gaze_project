...
static const _WalkingParam_type_support_symbol_names_t _WalkingParam_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_walking_module_msgs, msg, WalkingParam)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, op3_walking_module_msgs, msg, WalkingParam)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, op3_walking_module_msgs, msg, WalkingParam)() {
  return &::op3_walking_module_msgs::msg::rosidl_typesupport_c::WalkingParam_message_type_support_handle;
}
