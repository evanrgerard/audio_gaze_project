...
op3_walking_module_msgs__srv__GetWalkingParam_Request__are_equal(const op3_walking_module_msgs__srv__GetWalkingParam_Request * lhs, const op3_walking_module_msgs__srv__GetWalkingParam_Request * rhs)
{
  ...
  // get_param
  if (lhs->get_param != rhs->get_param) {
    return false;
  }
  return true;
}
  ...
  op3_walking_module_msgs__srv__GetWalkingParam_Request * output)
{
  ...
  // get_param
  output->get_param = input->get_param;
  return true;
}
...
op3_walking_module_msgs__srv__GetWalkingParam_Request__create()
{
  ...
  op3_walking_module_msgs__srv__GetWalkingParam_Request * msg = (op3_walking_module_msgs__srv__GetWalkingParam_Request *)allocator.allocate(sizeof(op3_walking_module_msgs__srv__GetWalkingParam_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(op3_walking_module_msgs__srv__GetWalkingParam_Request));
  bool success = op3_walking_module_msgs__srv__GetWalkingParam_Request__init(msg);
  if (!success) {
...
op3_walking_module_msgs__srv__GetWalkingParam_Request__destroy(op3_walking_module_msgs__srv__GetWalkingParam_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    op3_walking_module_msgs__srv__GetWalkingParam_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
op3_walking_module_msgs__srv__GetWalkingParam_Request__Sequence__init(op3_walking_module_msgs__srv__GetWalkingParam_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  op3_walking_module_msgs__srv__GetWalkingParam_Request * data = NULL;

  if (size) {
    data = (op3_walking_module_msgs__srv__GetWalkingParam_Request *)allocator.zero_allocate(size, sizeof(op3_walking_module_msgs__srv__GetWalkingParam_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = op3_walking_module_msgs__srv__GetWalkingParam_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        op3_walking_module_msgs__srv__GetWalkingParam_Request__fini(&data[i - 1]);
      }
...
op3_walking_module_msgs__srv__GetWalkingParam_Request__Sequence__fini(op3_walking_module_msgs__srv__GetWalkingParam_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      op3_walking_module_msgs__srv__GetWalkingParam_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  op3_walking_module_msgs__srv__GetWalkingParam_Request__Sequence * array = (op3_walking_module_msgs__srv__GetWalkingParam_Request__Sequence *)allocator.allocate(sizeof(op3_walking_module_msgs__srv__GetWalkingParam_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = op3_walking_module_msgs__srv__GetWalkingParam_Request__Sequence__init(array, size);
  if (!success) {
...
op3_walking_module_msgs__srv__GetWalkingParam_Request__Sequence__destroy(op3_walking_module_msgs__srv__GetWalkingParam_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    op3_walking_module_msgs__srv__GetWalkingParam_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
op3_walking_module_msgs__srv__GetWalkingParam_Request__Sequence__are_equal(const op3_walking_module_msgs__srv__GetWalkingParam_Request__Sequence * lhs, const op3_walking_module_msgs__srv__GetWalkingParam_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!op3_walking_module_msgs__srv__GetWalkingParam_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  op3_walking_module_msgs__srv__GetWalkingParam_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(op3_walking_module_msgs__srv__GetWalkingParam_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    op3_walking_module_msgs__srv__GetWalkingParam_Request * data =
      (op3_walking_module_msgs__srv__GetWalkingParam_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!op3_walking_module_msgs__srv__GetWalkingParam_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          op3_walking_module_msgs__srv__GetWalkingParam_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!op3_walking_module_msgs__srv__GetWalkingParam_Request__copy(
...
op3_walking_module_msgs__srv__GetWalkingParam_Response__init(op3_walking_module_msgs__srv__GetWalkingParam_Response * msg)
{
  ...
  // parameters
  if (!op3_walking_module_msgs__msg__WalkingParam__init(&msg->parameters)) {
    op3_walking_module_msgs__srv__GetWalkingParam_Response__fini(msg);
    return false;
  }
  return true;
}
...
op3_walking_module_msgs__srv__GetWalkingParam_Response__fini(op3_walking_module_msgs__srv__GetWalkingParam_Response * msg)
{
  ...
  // parameters
  op3_walking_module_msgs__msg__WalkingParam__fini(&msg->parameters);
}
...
op3_walking_module_msgs__srv__GetWalkingParam_Response__are_equal(const op3_walking_module_msgs__srv__GetWalkingParam_Response * lhs, const op3_walking_module_msgs__srv__GetWalkingParam_Response * rhs)
{
  ...
  // parameters
  if (!op3_walking_module_msgs__msg__WalkingParam__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  op3_walking_module_msgs__srv__GetWalkingParam_Response * msg = (op3_walking_module_msgs__srv__GetWalkingParam_Response *)allocator.allocate(sizeof(op3_walking_module_msgs__srv__GetWalkingParam_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(op3_walking_module_msgs__srv__GetWalkingParam_Response));
  bool success = op3_walking_module_msgs__srv__GetWalkingParam_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
op3_walking_module_msgs__srv__GetWalkingParam_Response__Sequence__init(op3_walking_module_msgs__srv__GetWalkingParam_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  op3_walking_module_msgs__srv__GetWalkingParam_Response * data = NULL;

  if (size) {
    data = (op3_walking_module_msgs__srv__GetWalkingParam_Response *)allocator.zero_allocate(size, sizeof(op3_walking_module_msgs__srv__GetWalkingParam_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = op3_walking_module_msgs__srv__GetWalkingParam_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        op3_walking_module_msgs__srv__GetWalkingParam_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
op3_walking_module_msgs__srv__GetWalkingParam_Response__Sequence__fini(op3_walking_module_msgs__srv__GetWalkingParam_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      op3_walking_module_msgs__srv__GetWalkingParam_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  op3_walking_module_msgs__srv__GetWalkingParam_Response__Sequence * array = (op3_walking_module_msgs__srv__GetWalkingParam_Response__Sequence *)allocator.allocate(sizeof(op3_walking_module_msgs__srv__GetWalkingParam_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = op3_walking_module_msgs__srv__GetWalkingParam_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
op3_walking_module_msgs__srv__GetWalkingParam_Response__Sequence__destroy(op3_walking_module_msgs__srv__GetWalkingParam_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    op3_walking_module_msgs__srv__GetWalkingParam_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
op3_walking_module_msgs__srv__GetWalkingParam_Response__Sequence__are_equal(const op3_walking_module_msgs__srv__GetWalkingParam_Response__Sequence * lhs, const op3_walking_module_msgs__srv__GetWalkingParam_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!op3_walking_module_msgs__srv__GetWalkingParam_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  op3_walking_module_msgs__srv__GetWalkingParam_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(op3_walking_module_msgs__srv__GetWalkingParam_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    op3_walking_module_msgs__srv__GetWalkingParam_Response * data =
      (op3_walking_module_msgs__srv__GetWalkingParam_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!op3_walking_module_msgs__srv__GetWalkingParam_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          op3_walking_module_msgs__srv__GetWalkingParam_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!op3_walking_module_msgs__srv__GetWalkingParam_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
