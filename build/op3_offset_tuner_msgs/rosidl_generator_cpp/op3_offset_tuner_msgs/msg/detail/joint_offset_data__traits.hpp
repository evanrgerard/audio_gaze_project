...
#ifndef OP3_OFFSET_TUNER_MSGS__MSG__DETAIL__JOINT_OFFSET_DATA__TRAITS_HPP_
#define OP3_OFFSET_TUNER_MSGS__MSG__DETAIL__JOINT_OFFSET_DATA__TRAITS_HPP_
...
inline void to_yaml(
  const op3_offset_tuner_msgs::msg::JointOffsetData & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const op3_offset_tuner_msgs::msg::JointOffsetData & msg)
{
  return op3_offset_tuner_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<op3_offset_tuner_msgs::msg::JointOffsetData>()
{
  return "op3_offset_tuner_msgs::msg::JointOffsetData";
}

template<>
inline const char * name<op3_offset_tuner_msgs::msg::JointOffsetData>()
{
  return "op3_offset_tuner_msgs/msg/JointOffsetData";
}

template<>
struct has_fixed_size<op3_offset_tuner_msgs::msg::JointOffsetData>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<op3_offset_tuner_msgs::msg::JointOffsetData>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<op3_offset_tuner_msgs::msg::JointOffsetData>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // OP3_OFFSET_TUNER_MSGS__MSG__DETAIL__JOINT_OFFSET_DATA__TRAITS_HPP_
