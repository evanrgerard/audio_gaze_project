...
#ifndef OP3_OFFSET_TUNER_MSGS__SRV__DETAIL__GET_PRESENT_JOINT_OFFSET_DATA__FUNCTIONS_H_
#define OP3_OFFSET_TUNER_MSGS__SRV__DETAIL__GET_PRESENT_JOINT_OFFSET_DATA__FUNCTIONS_H_
 ...
 * calls
 * op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Request__init().
...
/**
 * It calls
 * op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Request__fini()
 ...
 * op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_op3_offset_tuner_msgs
...
/**
 * It calls
 * op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_op3_offset_tuner_msgs
...
/**
 * It allocates the memory for the array and calls
 * op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_op3_offset_tuner_msgs
...
/**
 * It calls
 * op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // OP3_OFFSET_TUNER_MSGS__SRV__DETAIL__GET_PRESENT_JOINT_OFFSET_DATA__FUNCTIONS_H_
