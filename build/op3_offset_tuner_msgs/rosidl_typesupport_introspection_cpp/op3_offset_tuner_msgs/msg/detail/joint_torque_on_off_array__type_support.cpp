...
{
  new (message_memory) op3_offset_tuner_msgs::msg::JointTorqueOnOffArray(_init);
}

void JointTorqueOnOffArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<op3_offset_tuner_msgs::msg::JointTorqueOnOffArray *>(message_memory);
...
{
  const auto * member = reinterpret_cast<const std::vector<op3_offset_tuner_msgs::msg::JointTorqueOnOff> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<op3_offset_tuner_msgs::msg::JointTorqueOnOff> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<op3_offset_tuner_msgs::msg::JointTorqueOnOff> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const op3_offset_tuner_msgs::msg::JointTorqueOnOff *>(
    get_const_function__JointTorqueOnOffArray__torque_enable_data(untyped_member, index));
  auto & value = *reinterpret_cast<op3_offset_tuner_msgs::msg::JointTorqueOnOff *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<op3_offset_tuner_msgs::msg::JointTorqueOnOff *>(
    get_function__JointTorqueOnOffArray__torque_enable_data(untyped_member, index));
  const auto & value = *reinterpret_cast<const op3_offset_tuner_msgs::msg::JointTorqueOnOff *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointTorqueOnOffArray_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<op3_offset_tuner_msgs::msg::JointTorqueOnOff>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(op3_offset_tuner_msgs::msg::JointTorqueOnOffArray, torque_enable_data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JointTorqueOnOffArray_message_members = {
  ...
  1,  // number of fields
  sizeof(op3_offset_tuner_msgs::msg::JointTorqueOnOffArray),
...
{
  return &::op3_offset_tuner_msgs::msg::rosidl_typesupport_introspection_cpp::JointTorqueOnOffArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_offset_tuner_msgs, msg, JointTorqueOnOffArray)() {
  return &::op3_offset_tuner_msgs::msg::rosidl_typesupport_introspection_cpp::JointTorqueOnOffArray_message_type_support_handle;
}
