...
{
  new (message_memory) op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Request(_init);
}

void GetPresentJointOffsetData_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetPresentJointOffsetData_Request_message_member_array[1] = {
  {
    ...
    offsetof(op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Request, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetPresentJointOffsetData_Request_message_members = {
  "op3_offset_tuner_msgs::srv",  // message namespace
  "GetPresentJointOffsetData_Request",  // message name
  1,  // number of fields
  sizeof(op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Request),
...
{
  return &::op3_offset_tuner_msgs::srv::rosidl_typesupport_introspection_cpp::GetPresentJointOffsetData_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_offset_tuner_msgs, srv, GetPresentJointOffsetData_Request)() {
  return &::op3_offset_tuner_msgs::srv::rosidl_typesupport_introspection_cpp::GetPresentJointOffsetData_Request_message_type_support_handle;
}
...
void GetPresentJointOffsetData_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Response(_init);
}

void GetPresentJointOffsetData_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Response *>(message_memory);
...
{
  const auto * member = reinterpret_cast<const std::vector<op3_offset_tuner_msgs::msg::JointOffsetPositionData> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<op3_offset_tuner_msgs::msg::JointOffsetPositionData> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<op3_offset_tuner_msgs::msg::JointOffsetPositionData> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const op3_offset_tuner_msgs::msg::JointOffsetPositionData *>(
    get_const_function__GetPresentJointOffsetData_Response__present_data_array(untyped_member, index));
  auto & value = *reinterpret_cast<op3_offset_tuner_msgs::msg::JointOffsetPositionData *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<op3_offset_tuner_msgs::msg::JointOffsetPositionData *>(
    get_function__GetPresentJointOffsetData_Response__present_data_array(untyped_member, index));
  const auto & value = *reinterpret_cast<const op3_offset_tuner_msgs::msg::JointOffsetPositionData *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetPresentJointOffsetData_Response_message_member_array[1] = {
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<op3_offset_tuner_msgs::msg::JointOffsetPositionData>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Response, present_data_array),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetPresentJointOffsetData_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Response),
...
{
  return &::op3_offset_tuner_msgs::srv::rosidl_typesupport_introspection_cpp::GetPresentJointOffsetData_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_offset_tuner_msgs, srv, GetPresentJointOffsetData_Response)() {
  return &::op3_offset_tuner_msgs::srv::rosidl_typesupport_introspection_cpp::GetPresentJointOffsetData_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers GetPresentJointOffsetData_service_members = {
  "op3_offset_tuner_msgs::srv",  // service namespace
  "GetPresentJointOffsetData",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<op3_offset_tuner_msgs::srv::GetPresentJointOffsetData>()
...
get_service_type_support_handle<op3_offset_tuner_msgs::srv::GetPresentJointOffsetData>()
{
  ...
  auto service_type_support =
    &::op3_offset_tuner_msgs::srv::rosidl_typesupport_introspection_cpp::GetPresentJointOffsetData_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_offset_tuner_msgs, srv, GetPresentJointOffsetData)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<op3_offset_tuner_msgs::srv::GetPresentJointOffsetData>();
}
