...
bool op3_offset_tuner_msgs__msg__joint_torque_on_off__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("op3_offset_tuner_msgs.msg._joint_torque_on_off.JointTorqueOnOff", full_classname_dest, 63) == 0);
  }
  op3_offset_tuner_msgs__msg__JointTorqueOnOff * ros_message = _ros_message;
  {  // joint_name
...
PyObject * op3_offset_tuner_msgs__msg__joint_torque_on_off__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("op3_offset_tuner_msgs.msg._joint_torque_on_off");
