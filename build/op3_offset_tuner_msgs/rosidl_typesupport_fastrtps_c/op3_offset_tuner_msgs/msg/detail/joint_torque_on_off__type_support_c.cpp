...
#include "op3_offset_tuner_msgs/msg/detail/joint_torque_on_off__rosidl_typesupport_fastrtps_c.h"
...
using _JointTorqueOnOff__ros_msg_type = op3_offset_tuner_msgs__msg__JointTorqueOnOff;
...
static uint32_t _JointTorqueOnOff__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_op3_offset_tuner_msgs__msg__JointTorqueOnOff(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = op3_offset_tuner_msgs__msg__JointTorqueOnOff;
    is_plain =
      (
...
static size_t _JointTorqueOnOff__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_op3_offset_tuner_msgs__msg__JointTorqueOnOff(
