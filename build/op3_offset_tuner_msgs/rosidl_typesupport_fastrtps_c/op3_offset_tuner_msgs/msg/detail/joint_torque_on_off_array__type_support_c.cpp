...
#include "op3_offset_tuner_msgs/msg/detail/joint_torque_on_off_array__rosidl_typesupport_fastrtps_c.h"
...
#include "op3_offset_tuner_msgs/msg/detail/joint_torque_on_off__functions.h"  // torque_enable_data
...
using _JointTorqueOnOffArray__ros_msg_type = op3_offset_tuner_msgs__msg__JointTorqueOnOffArray;
  ...
  // Field name: torque_enable_data
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, op3_offset_tuner_msgs, msg, JointTorqueOnOff
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: torque_enable_data
  {
    ...
    if (ros_message->torque_enable_data.data) {
      op3_offset_tuner_msgs__msg__JointTorqueOnOff__Sequence__fini(&ros_message->torque_enable_data);
    }
...
size_t get_serialized_size_op3_offset_tuner_msgs__msg__JointTorqueOnOffArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JointTorqueOnOffArray__ros_msg_type * ros_message = static_cast<const _JointTorqueOnOffArray__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name torque_enable_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_op3_offset_tuner_msgs__msg__JointTorqueOnOff(
...
static uint32_t _JointTorqueOnOffArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_op3_offset_tuner_msgs__msg__JointTorqueOnOffArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_offset_tuner_msgs
size_t max_serialized_size_op3_offset_tuner_msgs__msg__JointTorqueOnOffArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: torque_enable_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_op3_offset_tuner_msgs__msg__JointTorqueOnOff(
  ...
  if (is_plain) {
    ...
    using DataType = op3_offset_tuner_msgs__msg__JointTorqueOnOffArray;
    is_plain =
      (
...
static size_t _JointTorqueOnOffArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_op3_offset_tuner_msgs__msg__JointTorqueOnOffArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_offset_tuner_msgs, msg, JointTorqueOnOffArray)() {
