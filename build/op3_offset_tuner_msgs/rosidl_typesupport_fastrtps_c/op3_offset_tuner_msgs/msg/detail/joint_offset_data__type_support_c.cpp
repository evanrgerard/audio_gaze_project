...
#include "op3_offset_tuner_msgs/msg/detail/joint_offset_data__rosidl_typesupport_fastrtps_c.h"
...
using _JointOffsetData__ros_msg_type = op3_offset_tuner_msgs__msg__JointOffsetData;
  ...
  void * untyped_ros_message)
{
  ...
  _JointOffsetData__ros_msg_type * ros_message = static_cast<_JointOffsetData__ros_msg_type *>(untyped_ros_message);
  // Field name: joint_name
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_op3_offset_tuner_msgs__msg__JointOffsetData(
  const void * untyped_ros_message,
...
static uint32_t _JointOffsetData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_op3_offset_tuner_msgs__msg__JointOffsetData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_offset_tuner_msgs
size_t max_serialized_size_op3_offset_tuner_msgs__msg__JointOffsetData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = op3_offset_tuner_msgs__msg__JointOffsetData;
    is_plain =
      (
...
static size_t _JointOffsetData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_op3_offset_tuner_msgs__msg__JointOffsetData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_offset_tuner_msgs, msg, JointOffsetData)() {
