...
#include "op3_offset_tuner_msgs/srv/detail/get_present_joint_offset_data__rosidl_typesupport_fastrtps_c.h"
...
using _GetPresentJointOffsetData_Request__ros_msg_type = op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Request;
  ...
  void * untyped_ros_message)
{
  ...
  _GetPresentJointOffsetData_Request__ros_msg_type * ros_message = static_cast<_GetPresentJointOffsetData_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
...
size_t get_serialized_size_op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetPresentJointOffsetData_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_offset_tuner_msgs
size_t max_serialized_size_op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Request;
    is_plain =
      (
...
static size_t _GetPresentJointOffsetData_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_offset_tuner_msgs, srv, GetPresentJointOffsetData_Request)() {
...
#include "op3_offset_tuner_msgs/msg/detail/joint_offset_position_data__functions.h"  // present_data_array

// forward declare type support functions
size_t get_serialized_size_op3_offset_tuner_msgs__msg__JointOffsetPositionData(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_op3_offset_tuner_msgs__msg__JointOffsetPositionData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_offset_tuner_msgs, msg, JointOffsetPositionData)();


using _GetPresentJointOffsetData_Response__ros_msg_type = op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Response;
  ...
  // Field name: present_data_array
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, op3_offset_tuner_msgs, msg, JointOffsetPositionData
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _GetPresentJointOffsetData_Response__ros_msg_type * ros_message = static_cast<_GetPresentJointOffsetData_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: present_data_array
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
    ...
    if (ros_message->present_data_array.data) {
      op3_offset_tuner_msgs__msg__JointOffsetPositionData__Sequence__fini(&ros_message->present_data_array);
    }
    if (!op3_offset_tuner_msgs__msg__JointOffsetPositionData__Sequence__init(&ros_message->present_data_array, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_offset_tuner_msgs
size_t get_serialized_size_op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetPresentJointOffsetData_Response__ros_msg_type * ros_message = static_cast<const _GetPresentJointOffsetData_Response__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name present_data_array
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_op3_offset_tuner_msgs__msg__JointOffsetPositionData(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_op3_offset_tuner_msgs
size_t max_serialized_size_op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: present_data_array
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_op3_offset_tuner_msgs__msg__JointOffsetPositionData(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Response;
    is_plain =
      (
...
static size_t _GetPresentJointOffsetData_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_op3_offset_tuner_msgs__srv__GetPresentJointOffsetData_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_offset_tuner_msgs, srv, GetPresentJointOffsetData_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_offset_tuner_msgs, srv, GetPresentJointOffsetData)() {
