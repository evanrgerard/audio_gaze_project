...
#include "op3_offset_tuner_msgs/msg/detail/joint_torque_on_off__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const op3_offset_tuner_msgs::msg::JointTorqueOnOff & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  op3_offset_tuner_msgs::msg::JointTorqueOnOff & ros_message)
{
  // Member: joint_name
  cdr >> ros_message.joint_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = op3_offset_tuner_msgs::msg::JointTorqueOnOff;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const op3_offset_tuner_msgs::msg::JointTorqueOnOff *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<op3_offset_tuner_msgs::msg::JointTorqueOnOff *>(
    untyped_ros_message);
...
{
  return &op3_offset_tuner_msgs::msg::typesupport_fastrtps_cpp::_JointTorqueOnOff__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_offset_tuner_msgs, msg, JointTorqueOnOff)() {
  return &op3_offset_tuner_msgs::msg::typesupport_fastrtps_cpp::_JointTorqueOnOff__handle;
}
