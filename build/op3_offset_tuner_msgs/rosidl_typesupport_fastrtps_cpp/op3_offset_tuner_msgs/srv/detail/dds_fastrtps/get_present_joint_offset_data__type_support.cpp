...
#include "op3_offset_tuner_msgs/srv/detail/get_present_joint_offset_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_op3_offset_tuner_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Request>()
{
  return &op3_offset_tuner_msgs::srv::typesupport_fastrtps_cpp::_GetPresentJointOffsetData_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_offset_tuner_msgs, srv, GetPresentJointOffsetData_Request)() {
  return &op3_offset_tuner_msgs::srv::typesupport_fastrtps_cpp::_GetPresentJointOffsetData_Request__handle;
}
...
{
bool cdr_serialize(
  const op3_offset_tuner_msgs::msg::JointOffsetPositionData &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  op3_offset_tuner_msgs::msg::JointOffsetPositionData &);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_op3_offset_tuner_msgs
cdr_serialize(
  const op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: present_data_array
  {
    ...
    for (size_t i = 0; i < size; i++) {
      op3_offset_tuner_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Response & ros_message)
{
  // Member: present_data_array
  {
    uint32_t cdrSize;
    ...
    for (size_t i = 0; i < size; i++) {
      op3_offset_tuner_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: present_data_array
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        op3_offset_tuner_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: present_data_array
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        op3_offset_tuner_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_JointOffsetPositionData(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<op3_offset_tuner_msgs::srv::GetPresentJointOffsetData_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &op3_offset_tuner_msgs::srv::typesupport_fastrtps_cpp::_GetPresentJointOffsetData_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_offset_tuner_msgs, srv, GetPresentJointOffsetData_Response)() {
  return &op3_offset_tuner_msgs::srv::typesupport_fastrtps_cpp::_GetPresentJointOffsetData_Response__handle;
}
...
{
  return &op3_offset_tuner_msgs::srv::typesupport_fastrtps_cpp::_GetPresentJointOffsetData__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_offset_tuner_msgs, srv, GetPresentJointOffsetData)() {
  return &op3_offset_tuner_msgs::srv::typesupport_fastrtps_cpp::_GetPresentJointOffsetData__handle;
}
