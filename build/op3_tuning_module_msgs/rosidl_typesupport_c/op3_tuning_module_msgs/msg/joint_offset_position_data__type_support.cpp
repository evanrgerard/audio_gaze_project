...
static const _JointOffsetPositionData_type_support_symbol_names_t _JointOffsetPositionData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, op3_tuning_module_msgs, msg, JointOffsetPositionData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, op3_tuning_module_msgs, msg, JointOffsetPositionData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, op3_tuning_module_msgs, msg, JointOffsetPositionData)() {
  return &::op3_tuning_module_msgs::msg::rosidl_typesupport_c::JointOffsetPositionData_message_type_support_handle;
}
