...
bool op3_tuning_module_msgs__msg__joint_offset_position_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("op3_tuning_module_msgs.msg._joint_offset_position_data.JointOffsetPositionData", full_classname_dest, 78) == 0);
  }
  op3_tuning_module_msgs__msg__JointOffsetPositionData * ros_message = _ros_message;
  {  // joint_name
  ...
  {  // goal_value
    PyObject * field = PyObject_GetAttrString(_pymsg, "goal_value");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->goal_value = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // offset_value
    PyObject * field = PyObject_GetAttrString(_pymsg, "offset_value");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->offset_value = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // present_value
    PyObject * field = PyObject_GetAttrString(_pymsg, "present_value");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->present_value = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // p_gain
...
{
  /* NOTE(esteve): Call constructor of JointOffsetPositionData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("op3_tuning_module_msgs.msg._joint_offset_position_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointOffsetPositionData");
  ...
  {  // goal_value
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->goal_value);
    {
      int rc = PyObject_SetAttrString(_pymessage, "goal_value", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // offset_value
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->offset_value);
    {
      int rc = PyObject_SetAttrString(_pymessage, "offset_value", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // present_value
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->present_value);
    {
      int rc = PyObject_SetAttrString(_pymessage, "present_value", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
