...
bool op3_tuning_module_msgs__msg__joint_torque_on_off__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("op3_tuning_module_msgs.msg._joint_torque_on_off.JointTorqueOnOff", full_classname_dest, 64) == 0);
  }
  op3_tuning_module_msgs__msg__JointTorqueOnOff * ros_message = _ros_message;
  {  // joint_name
  ...
  {  // torque_enable
    ...
    ros_message->torque_enable = (Py_True == field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of JointTorqueOnOff */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("op3_tuning_module_msgs.msg._joint_torque_on_off");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointTorqueOnOff");
  ...
  {  // torque_enable
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->torque_enable ? 1 : 0);
    {
