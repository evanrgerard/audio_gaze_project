...
#ifndef OP3_TUNING_MODULE_MSGS__MSG__DETAIL__JOINT_OFFSET_POSITION_DATA__TRAITS_HPP_
#define OP3_TUNING_MODULE_MSGS__MSG__DETAIL__JOINT_OFFSET_POSITION_DATA__TRAITS_HPP_
...
inline void to_yaml(
  const op3_tuning_module_msgs::msg::JointOffsetPositionData & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const op3_tuning_module_msgs::msg::JointOffsetPositionData & msg)
{
  return op3_tuning_module_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<op3_tuning_module_msgs::msg::JointOffsetPositionData>()
{
  return "op3_tuning_module_msgs::msg::JointOffsetPositionData";
}

template<>
inline const char * name<op3_tuning_module_msgs::msg::JointOffsetPositionData>()
{
  return "op3_tuning_module_msgs/msg/JointOffsetPositionData";
}

template<>
struct has_fixed_size<op3_tuning_module_msgs::msg::JointOffsetPositionData>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<op3_tuning_module_msgs::msg::JointOffsetPositionData>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<op3_tuning_module_msgs::msg::JointOffsetPositionData>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // OP3_TUNING_MODULE_MSGS__MSG__DETAIL__JOINT_OFFSET_POSITION_DATA__TRAITS_HPP_
