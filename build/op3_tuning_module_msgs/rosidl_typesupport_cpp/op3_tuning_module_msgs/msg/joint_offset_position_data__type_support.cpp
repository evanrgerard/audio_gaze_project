...
static const _JointOffsetPositionData_type_support_symbol_names_t _JointOffsetPositionData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_tuning_module_msgs, msg, JointOffsetPositionData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, op3_tuning_module_msgs, msg, JointOffsetPositionData)),
  }
};
...
{
  return &::op3_tuning_module_msgs::msg::rosidl_typesupport_cpp::JointOffsetPositionData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, op3_tuning_module_msgs, msg, JointOffsetPositionData)() {
  return get_message_type_support_handle<op3_tuning_module_msgs::msg::JointOffsetPositionData>();
}
