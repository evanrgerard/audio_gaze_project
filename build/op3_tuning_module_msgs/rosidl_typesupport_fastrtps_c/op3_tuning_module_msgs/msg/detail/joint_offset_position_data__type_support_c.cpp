...
#include "op3_tuning_module_msgs/msg/detail/joint_offset_position_data__rosidl_typesupport_fastrtps_c.h"
...
using _JointOffsetPositionData__ros_msg_type = op3_tuning_module_msgs__msg__JointOffsetPositionData;
...
static uint32_t _JointOffsetPositionData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_op3_tuning_module_msgs__msg__JointOffsetPositionData(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = op3_tuning_module_msgs__msg__JointOffsetPositionData;
    is_plain =
      (
...
static size_t _JointOffsetPositionData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_op3_tuning_module_msgs__msg__JointOffsetPositionData(
