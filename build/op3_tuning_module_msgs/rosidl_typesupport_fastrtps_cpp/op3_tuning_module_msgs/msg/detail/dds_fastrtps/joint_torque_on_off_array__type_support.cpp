...
#include "op3_tuning_module_msgs/msg/detail/joint_torque_on_off_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const op3_tuning_module_msgs::msg::JointTorqueOnOff &,
...
cdr_serialize(
  const op3_tuning_module_msgs::msg::JointTorqueOnOffArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  op3_tuning_module_msgs::msg::JointTorqueOnOffArray & ros_message)
{
  // Member: torque_enable_data
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: torque_enable_data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        op3_tuning_module_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_JointTorqueOnOff(
  ...
  if (is_plain) {
    ...
    using DataType = op3_tuning_module_msgs::msg::JointTorqueOnOffArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const op3_tuning_module_msgs::msg::JointTorqueOnOffArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<op3_tuning_module_msgs::msg::JointTorqueOnOffArray *>(
    untyped_ros_message);
...
{
  return &op3_tuning_module_msgs::msg::typesupport_fastrtps_cpp::_JointTorqueOnOffArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, op3_tuning_module_msgs, msg, JointTorqueOnOffArray)() {
  return &op3_tuning_module_msgs::msg::typesupport_fastrtps_cpp::_JointTorqueOnOffArray__handle;
}
