...
op3_tuning_module_msgs__msg__JointOffsetData__init(op3_tuning_module_msgs__msg__JointOffsetData * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->joint_name)) {
    op3_tuning_module_msgs__msg__JointOffsetData__fini(msg);
    return false;
  }
  // goal_value
  // offset_value
...
op3_tuning_module_msgs__msg__JointOffsetData__create()
{
  ...
  op3_tuning_module_msgs__msg__JointOffsetData * msg = (op3_tuning_module_msgs__msg__JointOffsetData *)allocator.allocate(sizeof(op3_tuning_module_msgs__msg__JointOffsetData), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(op3_tuning_module_msgs__msg__JointOffsetData));
  bool success = op3_tuning_module_msgs__msg__JointOffsetData__init(msg);
  if (!success) {
...
op3_tuning_module_msgs__msg__JointOffsetData__Sequence__init(op3_tuning_module_msgs__msg__JointOffsetData__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  op3_tuning_module_msgs__msg__JointOffsetData * data = NULL;

  if (size) {
    data = (op3_tuning_module_msgs__msg__JointOffsetData *)allocator.zero_allocate(size, sizeof(op3_tuning_module_msgs__msg__JointOffsetData), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = op3_tuning_module_msgs__msg__JointOffsetData__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        op3_tuning_module_msgs__msg__JointOffsetData__fini(&data[i - 1]);
      }
...
op3_tuning_module_msgs__msg__JointOffsetData__Sequence__fini(op3_tuning_module_msgs__msg__JointOffsetData__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      op3_tuning_module_msgs__msg__JointOffsetData__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  op3_tuning_module_msgs__msg__JointOffsetData__Sequence * array = (op3_tuning_module_msgs__msg__JointOffsetData__Sequence *)allocator.allocate(sizeof(op3_tuning_module_msgs__msg__JointOffsetData__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = op3_tuning_module_msgs__msg__JointOffsetData__Sequence__init(array, size);
  if (!success) {
...
op3_tuning_module_msgs__msg__JointOffsetData__Sequence__destroy(op3_tuning_module_msgs__msg__JointOffsetData__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    op3_tuning_module_msgs__msg__JointOffsetData__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
op3_tuning_module_msgs__msg__JointOffsetData__Sequence__are_equal(const op3_tuning_module_msgs__msg__JointOffsetData__Sequence * lhs, const op3_tuning_module_msgs__msg__JointOffsetData__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!op3_tuning_module_msgs__msg__JointOffsetData__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  op3_tuning_module_msgs__msg__JointOffsetData__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(op3_tuning_module_msgs__msg__JointOffsetData);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    op3_tuning_module_msgs__msg__JointOffsetData * data =
      (op3_tuning_module_msgs__msg__JointOffsetData *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!op3_tuning_module_msgs__msg__JointOffsetData__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          op3_tuning_module_msgs__msg__JointOffsetData__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!op3_tuning_module_msgs__msg__JointOffsetData__copy(
