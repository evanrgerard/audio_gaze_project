...
bool robotis_controller_msgs__msg__write_control_table__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robotis_controller_msgs.msg._write_control_table.WriteControlTable", full_classname_dest, 66) == 0);
  }
  robotis_controller_msgs__msg__WriteControlTable * ros_message = _ros_message;
  {  // joint_name
  ...
  {  // start_item_name
    PyObject * field = PyObject_GetAttrString(_pymsg, "start_item_name");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->start_item_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // data_length
...
{
  /* NOTE(esteve): Call constructor of WriteControlTable */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robotis_controller_msgs.msg._write_control_table");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WriteControlTable");
  ...
  {  // start_item_name
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->start_item_name.data,
      strlen(ros_message->start_item_name.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "start_item_name", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
