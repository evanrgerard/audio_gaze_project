  ...
  void * untyped_ros_message)
{
  ...
  _SetJointModule_Request__ros_msg_type * ros_message = static_cast<_SetJointModule_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: joint_name
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
  ...
  void * untyped_ros_message)
{
  ...
  _SetJointModule_Response__ros_msg_type * ros_message = static_cast<_SetJointModule_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: result
  {
    uint8_t tmp;
    cdr >> tmp;
