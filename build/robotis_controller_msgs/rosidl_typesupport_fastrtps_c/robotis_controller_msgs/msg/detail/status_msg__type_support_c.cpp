...
#include "robotis_controller_msgs/msg/detail/status_msg__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // module_name, status_msg
#include "rosidl_runtime_c/string_functions.h"  // module_name, status_msg
...
using _StatusMsg__ros_msg_type = robotis_controller_msgs__msg__StatusMsg;

static bool _StatusMsg__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _StatusMsg__ros_msg_type * ros_message = static_cast<const _StatusMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _StatusMsg__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _StatusMsg__ros_msg_type * ros_message = static_cast<_StatusMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _StatusMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robotis_controller_msgs__msg__StatusMsg(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotis_controller_msgs__msg__StatusMsg;
    is_plain =
      (
...
static size_t _StatusMsg__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_robotis_controller_msgs__msg__StatusMsg(
...
static message_type_support_callbacks_t __callbacks_StatusMsg = {
  "robotis_controller_msgs::msg",
  "StatusMsg",
  _StatusMsg__cdr_serialize,
  _StatusMsg__cdr_deserialize,
  _StatusMsg__get_serialized_size,
  _StatusMsg__max_serialized_size
};

static rosidl_message_type_support_t _StatusMsg__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_StatusMsg,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotis_controller_msgs, msg, StatusMsg)() {
  return &_StatusMsg__type_support;
}
