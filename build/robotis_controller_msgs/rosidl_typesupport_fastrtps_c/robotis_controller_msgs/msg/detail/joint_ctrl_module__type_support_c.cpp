...
#include "robotis_controller_msgs/msg/detail/joint_ctrl_module__rosidl_typesupport_fastrtps_c.h"
...
using _JointCtrlModule__ros_msg_type = robotis_controller_msgs__msg__JointCtrlModule;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _JointCtrlModule__ros_msg_type * ros_message = static_cast<const _JointCtrlModule__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _JointCtrlModule__ros_msg_type * ros_message = static_cast<_JointCtrlModule__ros_msg_type *>(untyped_ros_message);
  // Field name: joint_name
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
size_t get_serialized_size_robotis_controller_msgs__msg__JointCtrlModule(
  const void * untyped_ros_message,
...
static uint32_t _JointCtrlModule__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robotis_controller_msgs__msg__JointCtrlModule(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotis_controller_msgs
size_t max_serialized_size_robotis_controller_msgs__msg__JointCtrlModule(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robotis_controller_msgs__msg__JointCtrlModule;
    is_plain =
      (
...
static size_t _JointCtrlModule__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robotis_controller_msgs__msg__JointCtrlModule(
...
static message_type_support_callbacks_t __callbacks_JointCtrlModule = {
...
static rosidl_message_type_support_t _JointCtrlModule__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JointCtrlModule,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotis_controller_msgs, msg, JointCtrlModule)() {
  return &_JointCtrlModule__type_support;
}
