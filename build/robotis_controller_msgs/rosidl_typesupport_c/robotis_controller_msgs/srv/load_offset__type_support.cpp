...
static const _LoadOffset_Request_type_support_symbol_names_t _LoadOffset_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotis_controller_msgs, srv, LoadOffset_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, LoadOffset_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotis_controller_msgs, srv, LoadOffset_Request)() {
  return &::robotis_controller_msgs::srv::rosidl_typesupport_c::LoadOffset_Request_message_type_support_handle;
}
...
static const _LoadOffset_Response_type_support_symbol_names_t _LoadOffset_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotis_controller_msgs, srv, LoadOffset_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, LoadOffset_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotis_controller_msgs, srv, LoadOffset_Response)() {
  return &::robotis_controller_msgs::srv::rosidl_typesupport_c::LoadOffset_Response_message_type_support_handle;
}
...
static const _LoadOffset_type_support_symbol_names_t _LoadOffset_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotis_controller_msgs, srv, LoadOffset)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, srv, LoadOffset)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, robotis_controller_msgs, srv, LoadOffset)() {
  return &::robotis_controller_msgs::srv::rosidl_typesupport_c::LoadOffset_service_type_support_handle;
}
