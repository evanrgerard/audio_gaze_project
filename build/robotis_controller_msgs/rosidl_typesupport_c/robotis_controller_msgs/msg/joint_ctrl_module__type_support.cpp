...
static const _JointCtrlModule_type_support_symbol_names_t _JointCtrlModule_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotis_controller_msgs, msg, JointCtrlModule)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotis_controller_msgs, msg, JointCtrlModule)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotis_controller_msgs, msg, JointCtrlModule)() {
  return &::robotis_controller_msgs::msg::rosidl_typesupport_c::JointCtrlModule_message_type_support_handle;
}
