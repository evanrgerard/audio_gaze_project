...
#ifndef ROBOTIS_CONTROLLER_MSGS__SRV__DETAIL__SET_JOINT_MODULE__FUNCTIONS_H_
#define ROBOTIS_CONTROLLER_MSGS__SRV__DETAIL__SET_JOINT_MODULE__FUNCTIONS_H_
...
/// Initialize srv/SetJointModule message.
/**
 ...
 * )) before or use
 * robotis_controller_msgs__srv__SetJointModule_Request__create()
...
/// Finalize srv/SetJointModule message.
/**
...
/// Create srv/SetJointModule message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robotis_controller_msgs__srv__SetJointModule_Request__init().
...
/// Destroy srv/SetJointModule message.
/**
 * It calls
 * robotis_controller_msgs__srv__SetJointModule_Request__fini()
...
/// Check for srv/SetJointModule message equality.
/**
...
/// Copy a srv/SetJointModule message.
/**
...
/// Initialize array of srv/SetJointModule messages.
/**
...
/// Finalize array of srv/SetJointModule messages.
/**
 * It calls
 * robotis_controller_msgs__srv__SetJointModule_Request__fini()
...
/// Create array of srv/SetJointModule messages.
/**
 * It allocates the memory for the array and calls
 * robotis_controller_msgs__srv__SetJointModule_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetJointModule messages.
/**
 * It calls
 * robotis_controller_msgs__srv__SetJointModule_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetJointModule message array equality.
/**
...
/// Copy an array of srv/SetJointModule messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * robotis_controller_msgs__srv__SetJointModule_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_robotis_controller_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robotis_controller_msgs__srv__SetJointModule_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robotis_controller_msgs
...
/**
 * It calls
 * robotis_controller_msgs__srv__SetJointModule_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robotis_controller_msgs
...
/**
 * It allocates the memory for the array and calls
 * robotis_controller_msgs__srv__SetJointModule_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robotis_controller_msgs
...
/**
 * It calls
 * robotis_controller_msgs__srv__SetJointModule_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOTIS_CONTROLLER_MSGS__SRV__DETAIL__SET_JOINT_MODULE__FUNCTIONS_H_
