...
robotis_controller_msgs__srv__GetJointModule_Request__init(robotis_controller_msgs__srv__GetJointModule_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__Sequence__init(&msg->joint_name, 0)) {
    robotis_controller_msgs__srv__GetJointModule_Request__fini(msg);
    return false;
  }
  return true;
}
...
robotis_controller_msgs__srv__GetJointModule_Request__create()
{
  ...
  robotis_controller_msgs__srv__GetJointModule_Request * msg = (robotis_controller_msgs__srv__GetJointModule_Request *)allocator.allocate(sizeof(robotis_controller_msgs__srv__GetJointModule_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotis_controller_msgs__srv__GetJointModule_Request));
  bool success = robotis_controller_msgs__srv__GetJointModule_Request__init(msg);
  if (!success) {
...
robotis_controller_msgs__srv__GetJointModule_Request__Sequence__init(robotis_controller_msgs__srv__GetJointModule_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotis_controller_msgs__srv__GetJointModule_Request * data = NULL;

  if (size) {
    data = (robotis_controller_msgs__srv__GetJointModule_Request *)allocator.zero_allocate(size, sizeof(robotis_controller_msgs__srv__GetJointModule_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotis_controller_msgs__srv__GetJointModule_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robotis_controller_msgs__srv__GetJointModule_Request__fini(&data[i - 1]);
      }
...
robotis_controller_msgs__srv__GetJointModule_Request__Sequence__fini(robotis_controller_msgs__srv__GetJointModule_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robotis_controller_msgs__srv__GetJointModule_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotis_controller_msgs__srv__GetJointModule_Request__Sequence * array = (robotis_controller_msgs__srv__GetJointModule_Request__Sequence *)allocator.allocate(sizeof(robotis_controller_msgs__srv__GetJointModule_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotis_controller_msgs__srv__GetJointModule_Request__Sequence__init(array, size);
  if (!success) {
...
robotis_controller_msgs__srv__GetJointModule_Request__Sequence__destroy(robotis_controller_msgs__srv__GetJointModule_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotis_controller_msgs__srv__GetJointModule_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotis_controller_msgs__srv__GetJointModule_Request__Sequence__are_equal(const robotis_controller_msgs__srv__GetJointModule_Request__Sequence * lhs, const robotis_controller_msgs__srv__GetJointModule_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotis_controller_msgs__srv__GetJointModule_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotis_controller_msgs__srv__GetJointModule_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotis_controller_msgs__srv__GetJointModule_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotis_controller_msgs__srv__GetJointModule_Request * data =
      (robotis_controller_msgs__srv__GetJointModule_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotis_controller_msgs__srv__GetJointModule_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotis_controller_msgs__srv__GetJointModule_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotis_controller_msgs__srv__GetJointModule_Request__copy(
...
robotis_controller_msgs__srv__GetJointModule_Response__init(robotis_controller_msgs__srv__GetJointModule_Response * msg)
{
  ...
  // joint_name
  if (!rosidl_runtime_c__String__Sequence__init(&msg->joint_name, 0)) {
    robotis_controller_msgs__srv__GetJointModule_Response__fini(msg);
    return false;
  }
  // module_name
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotis_controller_msgs__srv__GetJointModule_Response * msg = (robotis_controller_msgs__srv__GetJointModule_Response *)allocator.allocate(sizeof(robotis_controller_msgs__srv__GetJointModule_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotis_controller_msgs__srv__GetJointModule_Response));
  bool success = robotis_controller_msgs__srv__GetJointModule_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robotis_controller_msgs__srv__GetJointModule_Response__Sequence__init(robotis_controller_msgs__srv__GetJointModule_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotis_controller_msgs__srv__GetJointModule_Response * data = NULL;

  if (size) {
    data = (robotis_controller_msgs__srv__GetJointModule_Response *)allocator.zero_allocate(size, sizeof(robotis_controller_msgs__srv__GetJointModule_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotis_controller_msgs__srv__GetJointModule_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robotis_controller_msgs__srv__GetJointModule_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robotis_controller_msgs__srv__GetJointModule_Response__Sequence__fini(robotis_controller_msgs__srv__GetJointModule_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robotis_controller_msgs__srv__GetJointModule_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotis_controller_msgs__srv__GetJointModule_Response__Sequence * array = (robotis_controller_msgs__srv__GetJointModule_Response__Sequence *)allocator.allocate(sizeof(robotis_controller_msgs__srv__GetJointModule_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotis_controller_msgs__srv__GetJointModule_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robotis_controller_msgs__srv__GetJointModule_Response__Sequence__destroy(robotis_controller_msgs__srv__GetJointModule_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotis_controller_msgs__srv__GetJointModule_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotis_controller_msgs__srv__GetJointModule_Response__Sequence__are_equal(const robotis_controller_msgs__srv__GetJointModule_Response__Sequence * lhs, const robotis_controller_msgs__srv__GetJointModule_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotis_controller_msgs__srv__GetJointModule_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotis_controller_msgs__srv__GetJointModule_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotis_controller_msgs__srv__GetJointModule_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotis_controller_msgs__srv__GetJointModule_Response * data =
      (robotis_controller_msgs__srv__GetJointModule_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotis_controller_msgs__srv__GetJointModule_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotis_controller_msgs__srv__GetJointModule_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotis_controller_msgs__srv__GetJointModule_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
