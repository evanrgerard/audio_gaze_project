...
robotis_controller_msgs__msg__JointCtrlModule__init(robotis_controller_msgs__msg__JointCtrlModule * msg)
{
  ...
  if (!rosidl_runtime_c__String__Sequence__init(&msg->joint_name, 0)) {
    robotis_controller_msgs__msg__JointCtrlModule__fini(msg);
    return false;
  }
  // module_name
...
robotis_controller_msgs__msg__JointCtrlModule__create()
{
  ...
  robotis_controller_msgs__msg__JointCtrlModule * msg = (robotis_controller_msgs__msg__JointCtrlModule *)allocator.allocate(sizeof(robotis_controller_msgs__msg__JointCtrlModule), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotis_controller_msgs__msg__JointCtrlModule));
  bool success = robotis_controller_msgs__msg__JointCtrlModule__init(msg);
  if (!success) {
...
robotis_controller_msgs__msg__JointCtrlModule__Sequence__init(robotis_controller_msgs__msg__JointCtrlModule__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotis_controller_msgs__msg__JointCtrlModule * data = NULL;

  if (size) {
    data = (robotis_controller_msgs__msg__JointCtrlModule *)allocator.zero_allocate(size, sizeof(robotis_controller_msgs__msg__JointCtrlModule), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotis_controller_msgs__msg__JointCtrlModule__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robotis_controller_msgs__msg__JointCtrlModule__fini(&data[i - 1]);
      }
...
robotis_controller_msgs__msg__JointCtrlModule__Sequence__fini(robotis_controller_msgs__msg__JointCtrlModule__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robotis_controller_msgs__msg__JointCtrlModule__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotis_controller_msgs__msg__JointCtrlModule__Sequence * array = (robotis_controller_msgs__msg__JointCtrlModule__Sequence *)allocator.allocate(sizeof(robotis_controller_msgs__msg__JointCtrlModule__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotis_controller_msgs__msg__JointCtrlModule__Sequence__init(array, size);
  if (!success) {
...
robotis_controller_msgs__msg__JointCtrlModule__Sequence__destroy(robotis_controller_msgs__msg__JointCtrlModule__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotis_controller_msgs__msg__JointCtrlModule__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotis_controller_msgs__msg__JointCtrlModule__Sequence__are_equal(const robotis_controller_msgs__msg__JointCtrlModule__Sequence * lhs, const robotis_controller_msgs__msg__JointCtrlModule__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotis_controller_msgs__msg__JointCtrlModule__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotis_controller_msgs__msg__JointCtrlModule__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotis_controller_msgs__msg__JointCtrlModule);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotis_controller_msgs__msg__JointCtrlModule * data =
      (robotis_controller_msgs__msg__JointCtrlModule *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotis_controller_msgs__msg__JointCtrlModule__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotis_controller_msgs__msg__JointCtrlModule__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotis_controller_msgs__msg__JointCtrlModule__copy(
