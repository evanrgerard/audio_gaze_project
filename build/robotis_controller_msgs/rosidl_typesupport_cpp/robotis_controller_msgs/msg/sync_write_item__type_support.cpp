...
static const _SyncWriteItem_type_support_symbol_names_t _SyncWriteItem_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotis_controller_msgs, msg, SyncWriteItem)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotis_controller_msgs, msg, SyncWriteItem)),
  }
};
...
{
  return &::robotis_controller_msgs::msg::rosidl_typesupport_cpp::SyncWriteItem_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robotis_controller_msgs, msg, SyncWriteItem)() {
  return get_message_type_support_handle<robotis_controller_msgs::msg::SyncWriteItem>();
}
